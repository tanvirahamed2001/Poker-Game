...
public class Command implements Serializable {
    ...
    public enum Type {GAMES_LIST, PLAYER_INFO, TURN_CHOICE, GAME_CHOICE, MESSAGE, GAME_OVER, TURN_TOKEN, ELECTION, HEARTBEAT, SERVER_CLIENT_ID, TABLE_INFO, RECONNECT, INITIAL_CONN, CLIENT_UPDATE_PLAYER}
